...
class connection_N
{
    ...
    private  $_user = "root";
    private  $_pass = "";
    private  $_dbname = "north";
    public   $conn;

    function __construct()
    {
        $this->conn = new mysqli($this->_server, $this->_user, $this->_pass, $this->_dbname) or die("connection_N failed: " . $this->conn->connect_error);
    }
    function __destruct()
    {
        $this->conn->close();
